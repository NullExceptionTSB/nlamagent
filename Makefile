...
pkgdatadir = $(datadir)/nlamagent
pkgincludedir = $(includedir)/nlamagent
pkglibdir = $(libdir)/nlamagent
pkglibexecdir = $(libexecdir)/nlamagent
...
am__v_CCLD_1 = 
SOURCES = $(nlamagent_SOURCES)
DIST_SOURCES = $(nlamagent_SOURCES)
...
ACLOCAL = ${SHELL} '/home/NullException/nlamagent/mkaux/missing' aclocal-1.16
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} '/home/NullException/nlamagent/mkaux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/NullException/nlamagent/mkaux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/NullException/nlamagent/mkaux/missing' automake-1.16
AWK = gawk
CC = gcc
...
CTAGS = ctags
CYGPATH_W = cygpath -w
DEFS = -DPACKAGE_NAME=\"NLAMAgent\" -DPACKAGE_TARNAME=\"nlamagent\" -DPACKAGE_VERSION=\"0.1\" -DPACKAGE_STRING=\"NLAMAgent\ 0.1\" -DPACKAGE_BUGREPORT=\"nullexceptiontsb@proton.me\" -DPACKAGE_URL=\"\" -DPACKAGE=\"nlamagent\" -DVERSION=\"0.1\"
DEPDIR = .deps
ECHO_C = 
ECHO_N = -n
ECHO_T = 
...
OBJEXT = o
PACKAGE = nlamagent
PACKAGE_BUGREPORT = nullexceptiontsb@proton.me
PACKAGE_NAME = NLAMAgent
PACKAGE_STRING = NLAMAgent 0.1
PACKAGE_TARNAME = nlamagent
PACKAGE_URL = 
PACKAGE_VERSION = 0.1
PATH_SEPARATOR = :
SET_MAKE = 
...
STRIP = 
VERSION = 0.1
abs_builddir = /home/NullException/nlamagent
abs_srcdir = /home/NullException/nlamagent
abs_top_builddir = /home/NullException/nlamagent
abs_top_srcdir = /home/NullException/nlamagent
ac_ct_CC = gcc
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/NullException/nlamagent/mkaux/install-sh
...
nlamagent$(EXEEXT): $(nlamagent_OBJECTS) $(nlamagent_DEPENDENCIES) $(EXTRA_nlamagent_DEPENDENCIES) 
	...
	$(AM_V_CCLD)$(LINK) $(nlamagent_OBJECTS) $(nlamagent_LDADD) $(LIBS)
